...
public class Ball2 {
    ...
    public static ArrayList<Ball2> ballsP2P = new ArrayList<Ball2>();
    ...
    public Ball2(Bitmap img, float xPos, float yPos, int rad, type t)
    {
        speed_x = 0;
        speed_y = 0;
        x = xPos;
    ...
    public double distanceTo(Ball2 a, Ball2 b) {
        return Math.abs(Math.sqrt(((a.x - b.x) * (a.x - b.x)) + ((a.y - b.y) * (a.y - b.y))));
    }

    public void calculateNewVelocities(Ball2 firstBall, Ball2 secondBall) {
